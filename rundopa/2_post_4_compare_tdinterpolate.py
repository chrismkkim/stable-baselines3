...
a2c_e60 = plot_tdnet_interpolation.a2c[-1,:]
tdnet_e60_u128 = plot_tdnet_interpolation.tdnet_e60_u128
tdint1_e60_u128 = plot_tdnet_interpolation.tdinter[1,:]
tdint0_e60_u128 = plot_tdnet_interpolation.tdinter[0,:]
plt.figure(figsize=(2.3,1.5))
plt.hist(a2c_e60, bins=10, color='r', label='A2C', histtype='bar', alpha=0.3, range=(-200,300))
plt.hist(tdnet_e60_u128, bins=10, color='C2', label='TDnet', histtype='step', alpha=1, range=(-200,300))
plt.axvline(np.mean(tdnet_e60_u128), color='C2', linestyle='--')
plt.hist(tdint1_e60_u128, bins=10, color='b', label='TDint1', histtype='step', alpha=1, range=(-200,300))
plt.axvline(np.mean(tdint1_e60_u128), color='b', linestyle='--')
plt.legend(bbox_to_anchor=[1,1])
plt.tight_layout()
plt.savefig(pathfig + 'compare_tdnet_tdint.pdf')


plt.figure(figsize=(2.3,1.5))
plt.hist(a2c_e60, bins=10, color='r', label='A2C', histtype='bar', alpha=0.3, range=(-200,300))
plt.hist(tdint0_e60_u128, bins=10, color='k', label='TDint0', histtype='step', alpha=1, range=(-200,300))
plt.axvline(np.mean(tdint0_e60_u128), color='k', linestyle='--')
# plt.hist(tdint1_e60_u128, bins=10, color='b', label='TDint1', histtype='step', alpha=1, range=(-200,300))
# plt.axvline(np.mean(tdint1_e60_u128), color='b', linestyle='--')
plt.legend(bbox_to_anchor=[1,1])
plt.tight_layout()
plt.savefig(pathfig + 'compare_a2c_tdint.pdf')
