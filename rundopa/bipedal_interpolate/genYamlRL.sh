...
for n_inter in "${n_interpolate_list[@]}"; do
    for n_envs in "${n_envs_list[@]}"; do
        ...
        fname="/home/kimchm/RL/rl-baselines3-zoo/hyperparams/BipedalWalker-v3/tdnet_interpolate/swarm_rl_envs${n_envs}_units${n_units}_inter${n_inter}.yml"
        cat << EOF > "$fname"
BipedalWalker-v3:
    n_envs: $n_envs
    ...
    interpolation_constant: $n_inter
EOF
