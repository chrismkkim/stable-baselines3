...
def main():
    ...
    if not temporary_testing:
        ...
        yaml    = [f"swarm_meta_envs{sim_id_env}_units{sim_id_unit}_inter{sim_inter}_tmp2.yml", f"swarm_rl_envs{sim_id_env}_units{sim_id_unit}_inter{sim_inter}_tmp2.yml"]
